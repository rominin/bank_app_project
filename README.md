...
## Запуск в докере инфрастукртуры и сервисов
...
2. Сделайте файл для инициализации данных (пропертей) в consul исполняемым **chmod +x init-consul.sh**; поднимите keycloak, postgresql, consul
**docker compose up keycloak db consul**, дождитесь успешного запуска.
