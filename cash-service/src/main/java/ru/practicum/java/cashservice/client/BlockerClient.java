...
import ru.practicum.java.cashservice.dto.BlockCheckRequestDto;
import ru.practicum.java.cashservice.dto.BlockCheckResponseDto;
...
public class BlockerClient {
    ...
    public boolean fallbackCheckBlock(BlockCheckRequestDto checkRequest, Throwable ex) {
        System.out.println("Fallback triggered for request: " + checkRequest + " " + ex.getMessage());
        return true;
    }
